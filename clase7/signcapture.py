...
while camera.isOpened():
    ...
    if isBgCaptured == 1:
        ...
        cv2.imshow('background', thresh) #mandar este frame para capturar el gesto en imwrite
    ...
    if k == 27:  # press ESC to exit all windows at any time
        ...
        cv2.imwrite(f"C:/Users/zS22000728/Documents/InterfacesNaturalesDeUsuario/clase7/silhouettes/D_{str(i).zfill(3)}.jpg", thresh)
        i+=1
